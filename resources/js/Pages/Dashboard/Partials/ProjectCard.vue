<template>
    ...
    <div>
        ...
        <div class="flex">
            ...
            <div class="w-[102px]">
                <div class="flex items-center gap-2 justify-end mb-2">
                    <InputLabel for="selected" value="selected" class="text-white text-xl font-light leading-5" />
                    <input type="checkbox" id="selected" v-model="selected">
                </div>
                <div class="flex items-center gap-2 justify-end mb-2">
                    <InputLabel for="ended" value="ended" class="text-white text-xl font-light leading-5" />
                    <input type="checkbox" id="ended" v-model="ended">
                </div>
        ...
        <svg v-if="played" @click="stopTime"
