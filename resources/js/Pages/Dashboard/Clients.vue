        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 flex flex-wrap justify-between gap-5">
                    <div
                        class="p-4 pl-9 pt-9 text-white bg-blue-500 min-w-[360px] min-h-[220px] w-fit rounded relative overflow-hidden shadow-xl">
                        <svg class="absolute right-3 top-3 w-4 h-4 cursor-pointer" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
                        ...
                        <div class="w-20 h-20 bg-red-500 border border-black absolute -left-10 -top-10 rotate-45"></div>
                        <h2 class="text-white font-bold mb-2">Matt</h2>
                        <p class="mb-1">Prdiod from: 03/05/2024</p>
                        <p class="mb-1">Active Projects: 5</p>
                        <p class="mb-1">Total time: 10:25</p>
                        <p class="mb-1">Earnings: $400</p>
                        <p class="mb-1">Prioroty:
                            <span class=" cursor-pointer">High</span> /
                            <span class="c text-yellow-300 cursor-pointer">Middle</span> /
                            <span class=" cursor-pointer">Low</span>
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="w-20 h-20 bg-yellow-500 border border-black absolute -left-10 -top-10 rotate-45">
                        </div>
                        <h2 class="text-white font-bold mb-2">Matt</h2>
                        <p class="mb-1">Prdiod from: 03/05/2024</p>
                        <p class="mb-1">Active Projects: 5</p>
                    ...
                    <div
                        ...
                        <div class="w-20 h-20 bg-green-500 border border-black absolute -left-10 -top-10 rotate-45">
                        </div>
                        <h2 class="text-white font-bold mb-2">Matt</h2>
                        <p class="mb-1">Prdiod from: 03/05/2024</p>
                        <p class="mb-1">Active Projects: 5</p>
